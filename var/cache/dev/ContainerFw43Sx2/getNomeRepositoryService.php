...
// Returns the private 'App\Repository\NomeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\NomeRepository.php';

return $this->privates['App\\Repository\\NomeRepository'] = new \App\Repository\NomeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
