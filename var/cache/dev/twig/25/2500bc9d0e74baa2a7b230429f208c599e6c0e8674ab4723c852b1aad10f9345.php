...
/* edit.html.twig */
class __TwigTemplate_22c21d88bec2cd6b95ea4d2072fbdb86f274ebd4376230ae60dbf4bf445e95f9 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "_form.html.twig", ["button_label" => "Salvar"]);
        echo "
...
{% block body %}
    ...
    {{ include('_form.html.twig', {'button_label': 'Salvar'}) }}
    
    <a href=\"{{ path('usuario_index') }}\" class=\"btn btn-warning\">Voltar</a>

    {{ include('_delete_form.html.twig') }}
{% endblock %}
", "edit.html.twig", "C:\\xampp\\htdocs\\SKYDEV\\projetoy\\projetoRTDBrasil\\RTD-Brasil\\templates\\edit.html.twig");
    }
}
